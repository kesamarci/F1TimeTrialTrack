        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Assist = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Setup = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Wheather = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TracksRating", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TracksRating_Tracks_TrackId",
                        column: x => x.TrackId,
                        principalTable: "Tracks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    TTsId = table.Column<string>(type: "nvarchar(50)", nullable: false),
                    Rating = table.Column<int>(type: "int", nullable: false),
                    Comment = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TTsRating", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TTsRating_TTs_TTsId",
                        column: x => x.TTsId,
                        principalTable: "TTs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
